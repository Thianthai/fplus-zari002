...
| OQ-17 | callback ไป SFDC — **ย้ายไป ARI003 ทั้งหมด 2026-09-02** ผู้เรียก ZARI002 คือ SBPA ซึ่งได้ response แบบ synchronous อยู่แล้ว · `ZCL_ZARI002_SFDC_NOTIFY` ต้องถูกลบออกจาก RICEFW นี้ | — | Phase 3 | — | ✅ ปิดในขอบเขต ZARI002 |
...
| OQ-25 | 🔴 **payment ที่ถูก reject ไม่ถูกเขียนลง table เลย** — ถ้า ARI003 ต้องรายงานผล "การรับข้อมูล" ให้ SFDC โดยอ่านจาก table จะไม่มีอะไรให้อ่าน · **ทาง A** SBPA เป็นคนบอก SFDC เอง → ZARI002 ไม่ต้องแก้ · **ทาง B** ZARI002 เก็บใบที่ตกไว้ด้วย → ต้องรื้อ duplicate check ไม่งั้นส่งแก้เข้ามาใหม่จะติด `010` ตลอดกาล (ขัด OQ-09) | ผู้ใช้ + SBPA | Phase 5 | **บล็อกการออกแบบ ARI003** · และตอนนี้ SAP ไม่มีร่องรอยเลยว่าใบไหนถูกปฏิเสธเพราะอะไร | ⬜ |
...
| OQ-24 | callback ยิงกี่ครั้งต่อ request — **ตกไป 2026-09-02** พร้อม OQ-17 ไม่มี callback ใน ZARI002 แล้ว | — | Phase 5 | — | ✅ ปิดในขอบเขต ZARI002 |
